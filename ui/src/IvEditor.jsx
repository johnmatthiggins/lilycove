  ...
  return (
    <div class="text-gray-700">
      ...
      <div class="flex flex-row gap-2">
        ...
        <section class="flex flex-col gap-1">
          <button
            class="bg-white text-black hover:outline hover:outline-2 hover:outline-black hover:outline-solid border-2 border-2-solid border-2-gray-200 px-1 min-h-9 rounded-md hover:cursor-pointer hover:shadow-md shadow-sm font-bold"
            onClick={() => setIv(0, 31)}
          >
            MAX
          </button>
