...
function LazyImage({
  ...
  const [imageElement, setImageElement] = createSignal(null);
  ...
  return (
    <Show when={!error()} fallback={
      <div class="flex justify-center items-center" style={style() || {}}>
        <svg width={spinnerProps.width} height={spinnerProps.height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <Show when={!loading()} fallback={
        <div class="flex justify-center items-center" style={style() || {}}>
          <svg class="animate-spin" fill="#9ca3af" width={spinnerProps.width} height={spinnerProps.height} viewBox="-7 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
