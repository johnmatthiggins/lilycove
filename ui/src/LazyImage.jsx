  ...
  return (
    <Show when={!error()} fallback={
      ...
      <Show when={!loading()} fallback={
        <div class="flex justify-center items-center" style={style()}>
          <svg class="animate-spin" fill="rgb(229, 231, 235)" width={spinnerProps.width} height={spinnerProps.height} viewBox="-7 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
